...
Sometimes even rebuilt shapes still refuse to extrude. If this happens, scale the shape x10 and try again. After successful extrusion, scale back down by x0.1. Another cause for extrusion failure could be a polyline that's not closed. 
